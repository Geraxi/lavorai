...
const steps = [
  {
    ...
    text: "PDF o DOCX. Non ce l'hai? Generalo da zero con l'AI partendo dal tuo LinkedIn — ATS-friendly in 60 secondi.",
    meta: "1 min",
  },
  {
    n: "02",
    ...
    text: "Ruoli, città, RAL minima, modalità di lavoro, seniority. LavorAI candida solo dove vuoi davvero.",
    meta: "2 min",
  },
  {
    n: "03",
    icon: Zap,
    title: "Candidati in automatico",
    text: "LavorAI adatta CV + cover letter ad ogni annuncio e invia per te sui portali italiani e internazionali. Tu ricevi solo le risposte.",
    meta: "24/7",
  },
];
      ...
      <div className="container relative">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-balance text-4xl font-bold tracking-tight sm:text-5xl">
            Tre step. Poi{" "}
            <span className="text-gradient-accent">dimentica la ricerca.</span>
          </h2>
          <p className="mt-5 text-lg text-muted-foreground">
            Setup in 3 minuti. Da lì in poi LavorAI lavora per te mentre vivi la tua vita.
          </p>
        </Reveal>
